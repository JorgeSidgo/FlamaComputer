                    ...
                    <form action="" class="ui form" :id="id_form">
                        <div class="two fields">
                            <div v-for="campo in campos" class="field">
                                ...
                                <input v-else :type="campo.type" :name="campo.name" :id="campo.name" v-model.trim="campo.val" :disabled='campo.disabled' @change="cambioTextbox(campo.name,campo.val)" @keyup="envio('cambio')" @keyup.enter="envio" >
